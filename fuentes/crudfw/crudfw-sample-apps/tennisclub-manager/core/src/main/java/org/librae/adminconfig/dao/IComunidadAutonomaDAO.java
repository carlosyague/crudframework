...
/**
 * Interfaz del DAO para la entidad ComunidadAutonoma
 * 
 * @author asantamaria
 * @author aropero
 */
public interface IComunidadAutonomaDAO extends
        GenericDAO<ComunidadAutonoma, Long> {

    /**
     * Método encargado de obtener la lista de comunidades de un pais dado.
     * 
     * @param idPais
