...
public interface TreeState extends Serializable {
	...
	/**
	 * Expand the complete path specified. If any node in the path is already
	 * expanded, that node should be left as it is.
	 * 
	 * @param nodePath
	...
	/**
	 * Collapse the complete path specified. If any node in the path is already
	 * collapsed, that node should be left as it is.
	 * 
	 * @param nodePath
