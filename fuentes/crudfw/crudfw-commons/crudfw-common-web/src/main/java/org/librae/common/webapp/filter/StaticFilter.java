...
public class StaticFilter extends OncePerRequestFilter {
    ...
    public void initFilterBean() {
        final String includesParam = getFilterConfig().getInitParameter(
                INCLUDES_PARAMETER);
        ...
        final String excludesParam = getFilterConfig().getInitParameter(
                EXCLUDES_PARAMETER);
    ...
    public void doFilterInternal(HttpServletRequest request,
        ...
        final boolean pathExcluded = PatternMatchUtils.simpleMatch(excludes,
                path);
        final boolean pathIncluded = PatternMatchUtils.simpleMatch(includes,
                path);
