 ...
 * 
 * @author <a href="mailto:matt@raibledesigns.com">Matt Raible</a> Modifications
 *         and comments by <a href="mailto:bwnoll@gmail.com">Bryan Noll</a> This
 *         thing used to be named simply 'GenericManager' in versions of AppFuse
 *         prior to 2.0. It was renamed in an attempt to distinguish and
 *         describe it as something different than GenericManager.
 *         GenericManager is intended for subclassing, and was named Generic
 *         because 1) it has very general functionality and 2) is 'generic' in
 *         the Java 5 sense of the word... aka... it uses Generics.
