...
/**
 * Interfaz del DAO para la entidad Municipio
 * 
 * @author asantamaria
 * @author aropero
 */
public interface IMunicipioDAO extends GenericDAO<Municipio, Long> {

    /**
     * Método encargado de obtener la lista de municipios de una provincia dada.
     * 
     * @param idProvincia
     *            , identificador de la provincia.
     * @return lista de municipios.
     */
    public List<Municipio> obtenerMunicipiosByProvincia(Long idProvincia);
}