...
@Entity(name = Contacto4.ENTITY_NAME)
public class Contacto4 extends BaseObject {
	/**
	 ...
	 * POJO-JPA Constants
	 */
	public static final String ENTITY_NAME = "org.tennisclub.manager.model.Contacto4";	 
