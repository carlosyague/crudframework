...
/**
 * Interfaz del DAO para la entidad Localidad
 * 
 * @author asantamaria
 * @author aropero
 */
public interface ILocalidadDAO extends GenericDAO<Localidad, Long> {
    ...
    /**
     * Método encargado de obtener la lista de localidades de un municipio dado.
     * 
     * @param IdMunicipio
     *            , identificador del Municipio.
     * @return lista de localidades.
     */
    public List<Localidad> obtenerLocalidadesByMunicipio(Long idMunicipio);
}