...
public abstract class BasePageTestCase extends
     ...
     */
    @Override
    protected void onSetUp() throws LibraeException {
        try {
            super.onSetUp();
        } catch (Exception e) {
            throw new LibraeException(e.getMessage(), e);
        }
        ...
        final ApplicationFactory applicationFactory = (ApplicationFactory) FactoryFinder
    ...
    protected String[] getConfigLocations() {
        ...
        return new String[] {
                ...
                // common-auditoria
                "classpath:spring/appCtx-audit.xml" };
    }
}