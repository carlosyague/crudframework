 ...
 * @version $Revision: 472638 $ $Date: 2006-11-08 15:54:13 -0500 (Wed, 08 Nov
 *          2006) $
 */
public interface TreeModel extends Serializable {
	 ...
	 */
	public final static String SEPARATOR = String
	...
	/**
	 * Gets the TreeWalker associated with the model. Allows the user to
	 * customize the manner in which nodes are walked by the renderer.
	 * 
	 * @return TreeWalker
	 */
