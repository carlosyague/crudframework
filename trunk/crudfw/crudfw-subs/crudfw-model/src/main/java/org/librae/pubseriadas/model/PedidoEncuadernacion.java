...
@Entity(name = PedidoEncuadernacion.ENTITY_NAME)
@Table(name = PedidoEncuadernacion.TABLE_NAME)
public class PedidoEncuadernacion { // extends Pedido {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5521171910940464835L;
	
	public static final String  ENTITY_NAME								= "org.librae.pubseriadas.model.PedidoEncuadernacion";
	
	/**
     * Constantes para referencia de los atributos de PedidoEncuadernacion
     */
    ...
    public static final String	TABLE_NAME								= "SER_PEDIDOS_ENCUADERNACION";
	private static final String ID_GENERATOR_NAME						= "generator_ser_pedidos_encuadernacion";
    private static final String	ID_SEQUENCE_NAME						= "SEQ_SER_PEDIDOS_ENCUADERNAC";
    public static final String COLUMN_NAME_ID 							= "X_PEDIDO_ENCUADERNACION";
...
//    public static final String  COLUMN_NAME_SUSCRIPCION                 =  "SUS_X_SUSCRIPCION";
	...
	protected PedidoEncuadernacion() {
		super();
	}

	
	public PedidoEncuadernacion(String estado, Date fechaPedido, Date fechaPrevista,
...
//    @JoinColumn(name = PedidoEncuadernacion.COLUMN_NAME_SUSCRIPCION, referencedColumnName = Suscripcion.COLUMN_NAME_ID)
...
//	@JoinColumn(name = Suscripcion.COLUMN_NAME_PEDIDO_SUSCRIPCION)
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof PedidoEncuadernacion))
			return false;
		PedidoEncuadernacion other = (PedidoEncuadernacion) obj;
		if (fPartida == null) {
