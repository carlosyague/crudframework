...
/**
 * Interfaz del DAO para la entidad PermisoRol
 * 
 * @author asantamaria
 */
public interface IPermisoRolDAO extends GenericDAO<PermisoRol, Long> {

    /**
     * Borra el Rol asociado a un PermisoRol.
     * 
     * @param idRol
     *            , id del rol a borrar.
     */
    void borrarRoles(Long idRol);
     ...
     * @return
     */
    PermisoRol getPermisoRolByIds(Long idRol, Long idPermiso);
