...
/**
 * Interfaz del DAO para la entidad Provincia
 * 
 * @author asantamaria
 * @author aropero
 */
public interface IProvinciaDAO extends GenericDAO<Provincia, Long> {

    /**
     * Método encargado de obtener la lista de provincias de una comunidad dada.
     * 
     * @param idComunidad
     *            , identificador de la comunidad.
     * @return lista de provincias.
     */
    public List<Provincia> obtenerProvinciasByComunidad(Long idComunidad);
}