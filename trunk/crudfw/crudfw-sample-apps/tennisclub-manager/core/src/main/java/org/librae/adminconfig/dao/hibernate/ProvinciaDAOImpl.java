...
/**
 * Implementación del DAO para la entidad Provincia
 * 
 * @author asantamaria
 * @author aropero
 */
public class ProvinciaDAOImpl extends GenericDAOImpl<Provincia, Long> implements
        IProvinciaDAO {
    ...
    /**
     * @see org.librae.adminconfig.dao.IProvinciaDAO#obtenerProvinciasByComunidad(java.lang.Long)
     */
    @SuppressWarnings("unchecked")
    public List<Provincia> obtenerProvinciasByComunidad(final Long idComunidad) {
        final StringBuilder sb = new StringBuilder();
        sb.append("from " + Provincia.ENTITY_NAME
                + " p where p.comunidadAutonoma.id = ? ");
        final Object[] parametros = { idComunidad };
