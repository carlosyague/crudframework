package org.librae.common.dao.spring;
 ...
 * 
 * <pre>
 * &lt;bean class=&quot;org.librae.common.dao.spring.HibernateExtensionPostProcessor&quot;&gt;
 *     &lt;property name=&quot;mappingResources&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;org/librae/common/model/Foo.hbm.xml&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 *     &lt;property name=&quot;annotatedClasses&quot;&gt;
 *         &lt;list&gt;
 *             &lt;value&gt;org.librae.common.model.Bar&lt;/value&gt;
 *         &lt;/list&gt;
 *     &lt;/property&gt;
 * &lt;/bean&gt;
 * </pre>
...
public class HibernateExtensionPostProcessor implements
    ...
    /**
     * El campo sessionFactoryBeanName.
     */
    private String     sessionFactoryBeanName = "sessionFactory";

    /**
     * El campo mappingResources.
     */
    private List       mappingResources;

    /**
     * El campo annotatedClasses.
     */
    private List       annotatedClasses;

    /**
     * El campo configLocations.
     */
    private List       configLocations;

    /**
     * El campo hibernateProperties.
     */
    ...
    public final void postProcessBeanFactory(
        ...
        if (configurableListableBeanFactory
            ...
            final BeanDefinition sessionFactoryBeanDefinition = configurableListableBeanFactory
                    .getBeanDefinition(sessionFactoryBeanName);
            final MutablePropertyValues propertyValues = sessionFactoryBeanDefinition
                    .getPropertyValues();
            ...
            if (mappingResources != null) {
                ...
                final List existingMappingResources = (List) propertyValue
                        .getValue();
            ...
            if (configLocations != null) {
                ...
                final List existingConfigLocations = (List) propertyValue
                        .getValue();
            ...
            if (hibernateProperties != null) {
                ...
                final Properties existingHibernateProperties = (Properties) propertyValue
                        .getValue();
     ...
     */
    public final void setHibernateProperties(
