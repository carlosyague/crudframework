 ...
 * @version 1.0
 */
public class CrudAppException extends CrudException {
     ...
     */
    public CrudAppException(final String codigo) {
        super(codigo);
        this.codigo = codigo;
    }
     ...
     */
    public CrudAppException(final String codigo, final Throwable causa) {
        super(codigo, causa);
        this.codigo = codigo;
    }
     ...
     *            Excepción original que irá encapsulada.
     */
    public CrudAppException(final String codigo, final String mensaje,
